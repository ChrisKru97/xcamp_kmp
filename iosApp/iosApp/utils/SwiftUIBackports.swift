// MARK: - glassEffect Backport
// Extracted from: https://github.com/superwall/iOS-Backports
// Version: 1.0.5
// License: MIT
//
// DO NOT MODIFY THIS CODE - It is a minimal extraction of the glassEffect
// API from iOS-Backports library, adapted to work with iOS 15+.
// The original library requires iOS 17 due to Package.swift, but the
// source code is actually iOS 14 compatible.
//
// For updates, check: https://github.com/superwall/iOS-Backports
