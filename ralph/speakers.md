I want you to understand the speakers list and details of the app and plan how to implement it properly - the shared kotlin logic, firestore fetch (lazily on every app open on background after more important info is fetched and on forced pull-refresh) and iOS-only UI implementation utilizing that kotlin logic.
