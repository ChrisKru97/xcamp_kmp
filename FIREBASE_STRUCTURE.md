...
```json
{
  ...
  "type": "seminar|workshop|evening|gospel|food|prayer|internal",
  "startTime": "2025-07-19T17:30:00.153Z",
  "endTime": "2025-07-19T20:00:00.000Z", 
  "place": "PLACE_ID",           // Reference to places collection
  "speakers": ["SPEAKER_ID"],    // Array of speaker references
  "leader": "Leader name"        // Optional workshop leader
}
```

**Event Types:**
- `seminar` - Teaching sessions and lectures
- `workshop` - Interactive skill-building sessions  
- `evening` - Evening programs and entertainment
- `gospel` - Evangelistic sessions
- `food` - Meal times
- `prayer` - Prayer meetings
- `internal` - Staff/organizational meetings
