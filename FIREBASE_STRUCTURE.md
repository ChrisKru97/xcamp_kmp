...
**Field Details:**
- `uid`: UUID v4 as document ID (from JSON `id` field or auto-generated)
...
**Document ID:** UUID v4 (from JSON `id` field or auto-generated)
...
- `schedule_data/food.json` - Meal time data
- `schedule_data/gospel.json` - Gospel session data
- `schedule_data/prayers.json` - Prayer meeting data
- `schedule_data/night.json` - Evening program data
